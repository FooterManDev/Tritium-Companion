...
public final class Field extends com.google.flatbuffers.Table {
  ...
  public boolean isStatic() { int o = __offset(8); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  public boolean isDeprecated() { int o = __offset(10); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static int createField(FlatBufferBuilder builder,
    ...
    Field.addIsDeprecated(builder, isDeprecated);
    Field.addIsStatic(builder, isStatic);
    return Field.endField(builder);
  }

  public static void startField(FlatBufferBuilder builder) { builder.startTable(5); }
  public static void addName(FlatBufferBuilder builder, int nameOffset) { builder.addOffset(0, nameOffset, 0); }
  public static void addType(FlatBufferBuilder builder, int typeOffset) { builder.addOffset(1, typeOffset, 0); }
  public static void addIsStatic(FlatBufferBuilder builder, boolean isStatic) { builder.addBoolean(2, isStatic, false); }
  public static void addIsDeprecated(FlatBufferBuilder builder, boolean isDeprecated) { builder.addBoolean(3, isDeprecated, false); }
