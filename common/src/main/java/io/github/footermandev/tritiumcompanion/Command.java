        ...
        dispatcher.register(
                Commands.literal("dumpRegistry")
                        .executes(ctx -> {
                            ...
                            int biome = dumpRegistry(server, Registries.BIOME, Biome.DIRECT_CODEC, "biome");
                            send(s, biome, "Biomes");
                            ...
                            int configFeature = dumpRegistry(server, Registries.CONFIGURED_FEATURE, ConfiguredFeature.DIRECT_CODEC, "configured_feature");
                            send(s, configFeature, "Configured Features");
                            int placeFeature = dumpRegistry(server, Registries.PLACED_FEATURE, PlacedFeature.DIRECT_CODEC, "placed_feature");
                            send(s, placeFeature, "Placed Features");
                            int struct = dumpRegistry(server, Registries.STRUCTURE, Structure.DIRECT_CODEC, "structure");
                            send(s, struct, "Structures");
                            int structSet = dumpRegistry(server, Registries.STRUCTURE_SET, StructureSet.DIRECT_CODEC, "structure_set");
                            send(s, structSet, "Structure Sets");
                            int noise = dumpRegistry(server, Registries.NOISE_SETTINGS, NoiseGeneratorSettings.DIRECT_CODEC, "noise_settings");
                            send(s, noise, "Noise Settings");
